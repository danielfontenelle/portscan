...
N = nmap.PortScanner()
 ...
 ######################################Email: danielzinhooficial@gmail.com###################################################
 
alvo = raw_input("Alvo: IP ou URL exemplo:[www.google.com]: ")
porta1 = raw_input ("[0] Para escanear as principais portas, ou [2] para especificar a porta desejada, escolha uma option: ")
